...
interface CreateBookingInvoiceModalProps {
  isOpen: boolean
  onClose: () => void
  onCreateBookingInvoice: (invoiceData: any) => void
}
...
// Before the CreateBookingInvoiceModal function declaration, add our sample customers
...
export function CreateBookingInvoiceModal({ isOpen, onClose, onCreateBookingInvoice }: CreateBookingInvoiceModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onCreateBookingInvoice(invoiceData)
  }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl">Create Booking Invoice</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Textarea
                id="notes"
                placeholder="Additional notes or booking instructions..."
                value={notes}
          ...
          <div className="flex justify-end space-x-4">
            ...
            <Button type="submit">Print Booking Invoice</Button>
          </div>
        </form>
      </DialogContent>
    </Dialog>
